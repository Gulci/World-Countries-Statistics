...
<html class="no-js" lang="en">
  ...
  <nav class="top-bar" data-topbar role="navigation">
    ...
    <thead>
    <tr>
    <th scope="column" width="35">ID (int)</th>
    <th scope="column" width="75">Size (int)</th>
    <th scope="column" width="75">Name (char)</th>
    <th scope="column" width="50">Population (int)</th>
...
$sql = "SELECT * FROM majorCity ORDER BY majorCityID";
...
while(($row = $result->fetch_array(MYSQL_ASSOC))) {
	...
	echo "<tr>";
		echo "<td><span class='round label'>" . $row['majorCityID'] . "</span></td>";
		echo "<td>" . $row['size']."</td>";
		echo "<td>" . $row['name']."</td>";
