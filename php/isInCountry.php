...
<html class="no-js" lang="en">
  ...
  <nav class="top-bar" data-topbar role="navigation">
    ...
    <thead>
    <tr>
    <th scope="column" width="35">City ID (int)</th>
    <th scope="column" width="75">Country ID (int)</th>
    </tr>
    </thead>
...
$sql = "SELECT * FROM isInCountry ORDER BY cityID";
...
while(($row = $result->fetch_array(MYSQL_ASSOC))) {
	...
	echo "<tr>";
		echo "<td><span class='round label'>" . $row['cityID'] . "</span></td>";
