...
<html class="no-js" lang="en">
  ...
  <nav class="top-bar" data-topbar role="navigation">
    ...
    <thead>
    <tr>
    <th scope="column" width="35">Organization ID (int)</th>
    <th scope="column" width="75">Name (char)</th>
    <th scope="column" width="150">Type (char)</th>
    <th scope="column" width="50">Year Founded (int)</th>
    </tr>
    </thead>
...
$sql = "SELECT * FROM organization ORDER BY organizationID";
...
while(($row = $result->fetch_array(MYSQL_ASSOC))) {
	...
	echo "<tr>";
		echo "<td><span class='round label'>" . $row['organizationID'] . "</span></td>";
		echo "<td>" . $row['name']."</td>";
		echo "<td>" . $row['type']."</td>";
